...
class Init_ArithmeticOperator_Response_artimetic_result
{
public:
  Init_ArithmeticOperator_Response_artimetic_result()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::msg_srv_action_interface_example::srv::ArithmeticOperator_Response artimetic_result(::msg_srv_action_interface_example::srv::ArithmeticOperator_Response::_artimetic_result_type arg)
  {
    msg_.artimetic_result = std::move(arg);
    return std::move(msg_);
  }
...
{
  return msg_srv_action_interface_example::srv::builder::Init_ArithmeticOperator_Response_artimetic_result();
}
